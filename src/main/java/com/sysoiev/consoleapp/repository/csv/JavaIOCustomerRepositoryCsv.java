...
public class JavaIOCustomerRepositoryCsv implements CustomerRepository {
    private final String filePath = "src\\main\\resources\\csv\\customers.csv";
    private SpecialtiesRepository specialtiesRepository = new JavaIOSpecialtyRepositoryCsv();
